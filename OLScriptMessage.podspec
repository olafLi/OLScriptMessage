#
# Be sure to run `pod lib lint OLScriptMessage.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'OLScriptMessage/Classes/**/*'
  
  # s.resource_bundles = {
  #   'OLScriptMessage' => ['OLScriptMessage/Assets/*.png']
  # }
